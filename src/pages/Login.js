        ...
        <div className="bg-white">
                <div className="xl:px-20 md:px-10 sm:px-6 px-4 2xl:mx-auto 2xl:container md:flex  items-center justify-center flex flex-row-reverse">
                    ...
                    <div className="bg-white shadow-lg rounded xl:w-full lg:w-screen md:w-1/2 w-full sm:px-6 sm:py-10 px-2">
                        ...
                        <p tabIndex={0} className="focus:outline-none text-2xl font-extrabold leading-6 text-gray-800 lg:pb-10">
                            LOGIN
                        </p>
                        <div>
                        ...
                        <div className="mt-8">
                            <Link to="/"><button role="button" className="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-indigo-700 border rounded hover:bg-indigo-600 py-4 w-full">
                                Login
                            </button></Link>
                        </div>
