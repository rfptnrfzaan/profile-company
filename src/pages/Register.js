...
const Register = () => {
    ...
    return ( 
        <>
                ...
                <div className="xl:px-20 md:px-10 sm:px-6 px-4 2xl:mx-auto 2xl:container md:flex  items-center justify-center flex flex-row-reverse">
                    <div className=" md:hidden sm:mb-8 mb-6">

                    </div>
                    <div className="flex flex-col w-1/2 items-center mt-2">
                    <img src={Logo} className="" height={175} width={175}/>
                    <div className="bg-white shadow-lg rounded xl:w-full lg:w-screen md:w-1/2 w-full sm:px-6 sm:py-10 px-2">
                        
                        <p tabIndex={0} className="focus:outline-none text-2xl font-extrabold leading-6 text-gray-800 lg:pb-4">
                            REGISTER
                        </p>
                        <div className="mt-2">
                            ...
                            <input id="username" aria-labelledby="username" type="username" className="bg-gray-200 border rounded text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
                        </div>
                        <div className="mt-2">
                            ...
                            <input id="email" aria-labelledby="email" type="email" className="bg-gray-200 border rounded text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
                        </div>
                        ...
                        <div className="mt-8">
                            <Link to="/Login"><button role="button" className="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-indigo-700 border rounded hover:bg-indigo-600 py-4 w-full">
                                Register
                            </button></Link>
                        </div>
                    ...
                    <div className="xl:w-1/2 md:w-1/2 lg:mr-10 md:mt-0 mt-6">
                        <div className="flex items-start mt-44">
                            <div>
